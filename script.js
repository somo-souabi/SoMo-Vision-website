...
const SOMOVISION_SCRIPT_PLACEHOLDER = 'PASTE_SOMOVISION_GOOGLE_SCRIPT_URL_HERE';
...
const hasConfiguredScriptUrl = SOMOVISION_SCRIPT_URL && SOMOVISION_SCRIPT_URL !== SOMOVISION_SCRIPT_PLACEHOLDER;
...
form?.addEventListener('submit', async (event) => {
  ...
  if (!hasConfiguredScriptUrl) {
    statusMessage.textContent = 'Contact form is not available yet. Please try again soon.';
    return;
  }
